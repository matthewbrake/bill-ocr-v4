    ...
    return (
        <div className="flex-1 flex flex-col">
            ...
            <button
                ...
                disabled={disabled}
                className="w-full flex-1 flex flex-col items-center justify-center p-8 rounded-xl border-2 border-dashed border-slate-300 dark:border-slate-600 hover:border-sky-500 hover:bg-sky-50/50 dark:hover:bg-slate-700/50 transition-all duration-300 ease-in-out transform hover:-translate-y-1 hover:shadow-xl disabled:bg-slate-100 disabled:dark:bg-slate-800 disabled:cursor-not-allowed disabled:opacity-50"
            >
                <svg className="w-12 h-12 mb-4 text-slate-400 dark:text-slate-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
                 ...
                 <p className="text-base text-slate-500 dark:text-slate-400"><span className="font-semibold text-sky-600 dark:text-sky-400">Use camera</span> to snap a photo</p>
                 <p className="text-sm text-slate-400 dark:text-slate-500 mt-1">Best for physical documents</p>
            </button>
